...
<%
  String resourceSiteCSS = "/resources/sites/" + targetSite.getSiteresourcepath() + "/site_style.css";
%>      
<link href='<r3_lang:pathResolver path="<%=resourceSiteCSS%>" />' rel="stylesheet" type="text/css"/>
...
<%
  ...
  <r3_lang:script path2resolve="/resources/js/jquery_r3ng_js.js?build=20181212"     scriptEnv="runtime" />
  <r3_lang:script path2resolve="/resources/jsr3/jquery_r3ng_jsr3.js?build=20181212" scriptEnv="runtime" />
  ...
  <r3_lang:script path2resolve="/resources/js/timer-jquery/timer.jquery.min.js" scriptEnv="dev" />
  ...
  <r3_lang:script path2resolve="/org/r3/jquery_r3ng_jsappmsg.js?build=20181212"     scriptEnv="runtime" />  
  <r3_lang:script path2resolve="/org/r3/jquery_r3ng_jsappmsg_pt.js?build=20181212"  ifLanguage='pt'  scriptEnv="runtime" />  
  <r3_lang:script path2resolve="/org/r3/jquery_r3ng_jsapp.js?build=20181212"        scriptEnv="runtime" />
