...
<r3_lang:ifinclude include="<%=!targetSite.isConsoleCSSDefined()%>">  
<link href='<r3_lang:pathResolver path="/resources/bootstrap/css/style_shakeus.css" />' rel="stylesheet" type="text/css"/>
</r3_lang:ifinclude>
...
<link href='<r3_lang:pathResolver path="/resources/bootstrap/css/freewall/freewall.css" />' rel="stylesheet" type="text/css"/>
...
<script>
 ...
 <body class="hold-transition  layout-top-nav <%=siteTheme%>" style='height: 100%'>
  ...
  <r3_lang:ifinclude include="<%=siteBanner!=null%>">
  <div class='hidden-xs'  
    style="background: url('<%=siteBanner%>') no-repeat scroll left bottom #142A38; background-size: 100% 100%; width: 100%; position: relative; padding-bottom: 10%;">
      ...
      <jsp:include page="<%=topBannerLinks%>" flush="true" />      
          ...
          <section class="content-header clearfix" style='background-color: #ccc; padding-top: 0px; display:none'>
          
                  <ol class="breadcrumb" style='position: static; float: none; background-color: #ccc;'>
        </ol>
          </section>
...
<%
  ...
  <r3_lang:script path2resolve="/resources/js/freewall/freewall.js"       scriptEnv="any"/>
  ...
  <r3_lang:script path2resolve="/resources/js/flowplayer/flowplayer.hlsjs.min.js" scriptEnv="any" />
  ...
  <r3_lang:script path2resolve="/org/r3ts/siteconstants.do"   scriptEnv="any" />
  <r3_lang:script path2resolve="/org/r3ts/pagecontext.do"     scriptEnv="any" />
  <r3_lang:script path2resolve="/org/r3ts/constants.do"       scriptEnv="any" />
  ...
  <r3_lang:script path2resolve="/org/r3ts/Messages.js" />
  <r3_lang:script path2resolve="/org/r3/Messages_pt.json" ifLanguage='pt' />

  <r3_lang:script path2resolve="/org/r3ts/Validation.js" />
  <r3_lang:script path2resolve="/org/r3ts/RESTConfigManager.js" />
  <r3_lang:script path2resolve="/org/r3ts/RestDTOAdapter.js" />
  <r3_lang:script path2resolve="/org/r3ts/LUTManager.js" />

  <r3_lang:script path2resolve="/org/r3ts/PageManager.js" />
  <r3_lang:script path2resolve="/org/r3ts/AjaxUtils.js" />
  <r3_lang:script path2resolve="/org/r3ts/GoogleMapsUtils.js" />

  <r3_lang:script path2resolve="/org/r3ts/ActionFormView.js" />
  <r3_lang:script path2resolve="/org/r3ts/ActionFormManager.js" />
  <r3_lang:script path2resolve="/org/r3ts/BreadCrumbManager.js" />

  <r3_lang:script path2resolve="/org/r3ts/db/DataTableEntityActionFormView.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/DTOAdapter.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/DTOTableAdapter.js" />

  <r3_lang:script path2resolve="/org/r3ts/db/system/user/user/UserQueryActionFormView.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/system/user/user/UserDTOAdapter.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/system/user/user/UserDTO.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/system/user/user/UserDictionary.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/system/user/user/UserDictionary_pt.json" ifLanguage='pt' />
  
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/usercollection/UserCollectionDictionary.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/usercollection/UserCollectionDTO.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/usercollection/UserCollectionDTOAdapter.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/usercollection/UserCollectionQueryActionFormView.js" /> 
  
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/sitecollection/SiteCollectionDTO.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/sitecollection/SiteCollectionDTOAdapter.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/sitecollection/SiteCollectionDictionary.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/AddressDTOAdapter.js" />
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/MongoImageDTOAdapter.js" />  
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/MongoImageIconDTOAdapter.js" />  
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/MongoFileAttachmentDTOAdapter.js" />      
  <r3_lang:script path2resolve="/org/r3ts/db/mongo/MongoLinkDTOAdapter.js" />      
