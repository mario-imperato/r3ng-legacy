  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.$element.parent().hasClass('input-group')) {
        if (this.$element.parent('.input-group').find('.input-group-addon.timepicker-addon ').length) {
          this.$element.parent('.input-group').find('.input-group-addon.timepicker-addon ').on({
