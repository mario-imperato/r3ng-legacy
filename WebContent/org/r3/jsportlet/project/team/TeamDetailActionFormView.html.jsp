...
<div class="panel tabbed-panel">
  <div class="panel-heading clearfix" >  
    <h3 class="panel-title" style='line-height: 2em'>{%=org.r3.jsportlet.project.team.message.teamdetailactionform_form_legend%}: <span id="teamdetailactionform_teamid"></span>
  
  <div style='text-align: right; float: right'>
  {% if (o.teamDtoAdapter.getOnCompleteOKTask()) { %}  
  <button type="button" id='teamwf_action_{%=o.teamDtoAdapter.getOnCompleteOKTask()%}' class="btn btn-primary teamwf_action">{%=org.r3.db.project.team.message.getOnCompleteOkActionMessageForTask(o.teamDtoAdapter.dataBean.teamstatus)%}</button>    
  {% } %}
  
  {% if (o.teamDtoAdapter.getOnCompleteKOTask()) { %}
  <button type="button" id='teamwf_action_{%=o.teamDtoAdapter.getOnCompleteKOTask()%}' class="btn btn-warning teamwf_action">{%=org.r3.db.project.team.message.getOnCompleteKoActionMessageForTask(o.teamDtoAdapter.dataBean.teamstatus)%}</button>    
  {% } %}
  </div>
  ...
  <div class="form-group">
    <label class="col-md-4  control-label">{%=org.r3.db.project.team.message.teamstatus%}</label>
    <div class='col-md-8 '>
    <input class="form-control" type="text" name="teamstatus" id="teamdetailactionform_teamstatus" maxlength="40" disabled />
    </div>
  </div>
