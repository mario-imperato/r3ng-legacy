...
<div class="panel tabbed-panel">
  ...
  <div class="form-group">
    <label class="col-md-2 control-label ">{%=org.r3.db.project.resource.message.userid%}</label>
    <div class='col-md-10 single_picker' id='resourcedetailactionform_pickeruserid_cnt'>
    </div>
  </div>
  </div>
  </div>
