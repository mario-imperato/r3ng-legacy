...
org.r3.jsportlet.sev.rankingview.RankingInstanceViewerActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function(aRankInstanceDTOAdapter, consoleContext)
	{
		var _self = this;
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/sev/rankingview/RankingInstanceViewerActionFormView.html.jsp?mode=detail'),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
			...
			$('#rankinginstancevieweractionform_cyfile_canvas').html(responseData['content']);
	...
	showCyFile: function()
	{
		$('#rankinginstancevieweractionform_cyfile_panel').show();
	},
	
	hideCyFile: function()
	{
		$('#rankinginstancevieweractionform_cyfile_panel').hide();
	}
