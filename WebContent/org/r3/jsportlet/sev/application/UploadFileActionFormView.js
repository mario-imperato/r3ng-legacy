...
org.r3.jsportlet.sev.application.UploadFileActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function(anApplicationDTOAdapter)
	{
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/sev/application/UploadFileActionForm.html'),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
			...
			org.r3.PageManager.lutManager.populateSelectField(
			{
				...
				"selectWidget" : $('#docuploadform_documenttype')
			});

			$("#docuploadform_form").validate					
            ({
	        	   errorPlacement: $.r3Utils.layoutClassicErrorPlacement,
	               rules: org.r3.jsportlet.sev.application.docuploadform_form_validationRules,
		           messages: org.r3.jsportlet.sev.application.docuploadform_form_validationMessages    
	        });
					
			$('#docuploadform_action_back').button().unbind().click($.r3Utils.hitch(this, function(e) {
				this.hide();
				this.actionFormManager.closeDocumentUpload();
