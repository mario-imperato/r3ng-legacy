...
org.r3.jsportlet.user.UserQueryAdvancedSearchActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function()
	{
		...
		networkInitializationQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/user/UserQueryAdvancedSearchActionForm.html'),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
            ...
            ({
	               ...
	               rules: org.r3.jsportlet.user.advancedsearchform_form_validationRules,
		           messages: org.r3.jsportlet.user.advancedsearchform_form_validationMessages    
	        });
	...
	executeAdvancedSearch : function()
	{
		...
		qparams.push(
		{
			"name": "nickname", "value" : $('#userquery_advancedsearchform_form_nickname').attr('value')
		});
		qparams.push(
		{
