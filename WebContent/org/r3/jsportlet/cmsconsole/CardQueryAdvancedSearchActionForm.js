...
org.r3.jsportlet.cmsconsole.CardQueryAdvancedSearchActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function()
	{
		...
		networkInitializationQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/cmsconsole/CardQueryAdvancedSearchActionForm.html'),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
            ...
            ({
	               ...
	               rules: org.r3.jsportlet.cmsconsole.advancedsearchform_form_validationRules,
		           messages: org.r3.jsportlet.cmsconsole.advancedsearchform_form_validationMessages    
	        });
	...
	executeAdvancedSearch : function()
	{
		...
		qparams.push(
		{
			"name" : "cardid", "value" : $('#cardquery_advancedsearchform_form_cardid').val()
		});
