...
org.r3.jsportlet.cmsconsole.CardDetailActionForm = org.r3.ActionFormManager.extend(
{

	init : function(aPageManager, aDetailViewContainerId, aChildEntityListViewContainerId)
	{
		this.setPageManager(aPageManager);
		this.detailView = new org.r3.jsportlet.cmsconsole.CardDetailActionFormView(aDetailViewContainerId, this);
	},
	...
	_saveItem : function(isUpdate)
	{
		...
		if (theForm.valid() && org.r3.PageManager.confirmation("org.r3.message.saveconfirm"))
		{
			...
			if (isUpdate)
			{
				...
				restUrl = org.r3.PageManager.getRESTUrl('PUT_Card', [ idCard ]);
				method = "put";
			}
	...
	deleteItem : function()
	{
		...
		if (org.r3.PageManager.confirmation("org.r3.message.deleteconfirm"))
		{
			var method = "DELETE";
			var restUrl = null;
			var cardId = this.dataBeanInfo.dataBean.cardid;
	...
	{
		this.pageManager.closeNewCardPanel();
	},
	...
	updateCardDescr4Language: function(aLanguageCode)
	{
		...
		if (theForm.valid() && org.r3.PageManager.confirmation("org.r3.message.saveconfirm"))
		{
			var method = "put";
			var idCard = this.dataBeanInfo.dataBean.cardid;
			var restUrl = org.r3.PageManager.getRESTUrl('PUT_CardDescr_Detail',  [ idCard, aLanguageCode ]);
	...
	retrieveCardDescr: function(aLanguageCode, onComplete, onError)
	{
		...
		$.ajax(
		{
			...
			"error" : function(jqXHR, timeout, message)
			{
				console.error("org.r3.jsportlet.cmsconsole.CardDetailActionForm: ", message);
				if (onError)
					onError(message);	
			}
		});
