...
org.r3.jsportlet.cmsconsole.UploadFileActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function(aCardDTOAdapter)
	{
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/cmsconsole/UploadFileActionForm.html'),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
			...
			{
				"lutUrl" : org.r3.PageManager.getRESTUrl('LUT_CMS_Attachtype_default'),
			...
			var aRestUrl = 	org.r3.PageManager.getRESTUrl('POST_Card_File', [ aCardDTOAdapter.dataBean.cardid ]);
			if (r3_IE)
				aRestUrl =	org.r3.PageManager.getRESTUrl('POST_Card_File_IE', [ aCardDTOAdapter.dataBean.cardid ]);

			console.info('CardDTOAdapter: ' , aCardDTOAdapter);
