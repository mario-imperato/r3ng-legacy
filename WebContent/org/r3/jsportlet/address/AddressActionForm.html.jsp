...
<div class="panel {%=(o.isTabbedLayout ? 'tabbed-panel' : 'panel-default')%}">
  <div class="panel-heading" style='background: white'>  
    <h3 class="panel-title">{%#org.r3.jsportlet.address.message.panel_title%}</h3>
  </div>
  <div class="panel-body">
  <p>{%#org.r3.jsportlet.address.message.panel_info%}</p>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label fieldRequired">{%#org.r3.jsportlet.address.message.district%}</label>
    <div class='col-sm-10'>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label fieldRequired">{%#org.r3.jsportlet.address.message.county%}</label>
    <div class='col-sm-10'>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label fieldRequired">{%#org.r3.jsportlet.address.message.town%}</label>
    <div class='col-sm-10'>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label fieldRequired">{%#org.r3.jsportlet.address.message.zipcode%}</label>
    <div class='col-sm-10'>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label fieldRequired">{%#org.r3.jsportlet.address.message.address%}</label>
    <div class='col-sm-10'>
