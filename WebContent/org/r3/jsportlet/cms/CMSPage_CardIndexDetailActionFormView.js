...
org.r3.jsportlet.cms.CMSPage_CardIndexDetailActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function(pageInfo, cardInfo, options)
	{
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/cms/CMSPage_CardIndexDetailActionFormView.html.jsp'),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
			...
			this._fetchCardIndex(pageInfo, cardInfo, _self.cmsCardOptions);
			this.show();
		}),
	...
	_fetchCardIndex: function(pageInfo, cardInfo, options)
	{
		var _self = this;
		$(this.cmsCardOptions.cardIndexDivLocator).cmsCard(
		{
			...
			onComplete : function(responseInfo, numberOfItems)
			{
				...
				if (card2Fetch)
					_self._fetchCardDetail(pageInfo.pageid, card2Fetch);
