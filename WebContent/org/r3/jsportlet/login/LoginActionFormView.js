...
org.r3.jsportlet.login.LoginActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function(aConfigHash)
	{
		...
		var templateHtml = org.r3.Constants.applicationContext + '/org/r3/jsportlet/login/LoginActionForm_' + org.r3.Constants.language + '.html';
		if (aConfigHash && aConfigHash.templateFileName)
		{
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(templateHtml),
			dataType : "html"
		});
		...
		$.r3Utils.hitch(this, function(responseData)
		{
			...
			// Con l'opzione error placement disabilito l'eventuale errore...
