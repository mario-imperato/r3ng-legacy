...
org.r3.jsportlet.wbs.WBSQueryActionForm = org.r3.ActionFormManager.extend(
{
    ...
    init : function(aPageManager, anHtmlActionFormContainerId, anAdvancedSearchHtmlActionFormContainerId)
	{
		...
		// grade_clickable
		this.listView = new org.r3.db.wbs.wbs.WBSQueryActionFormView
		(
				anHtmlActionFormContainerId, 
				this,
				{
					dataTableId : 'WBSQueryActionFormView',
					gradeLevel : 'grade_level6 grade_clickable',
					legend : org.r3.db.wbs.wbs.message.WBSQueryActionFormView_caption,	
					iDisplayLength: 25,
					dataTableSource : 'GET_WBSes',
					layout : 'fullWidth',
					sortable: true,
					// onInitializationComplete : $.unepUtils.hitch(this, this.populateRiepilogo),
					dataTableColumns : "wbstitle",
					requiredLUTs : [ 
...
//	              	}
					...
					buttons : [
					{
						id : 'console_wbs_action_refresh',
						label : org.r3.jsportlet.wbs.message.console_wbs_action_refresh,
						disabled : false,
   ...
   openDetail: function(aWBSDTOAdapter)
   {
		this.listView.hide();
		this.pageManager.openWBSPanel(aWBSDTOAdapter);
   }         
