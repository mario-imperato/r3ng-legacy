...
org.r3.jsportlet.outmail.UploadFileActionFormView = org.r3.ActionFormView.extend(
{
	init : function(anHtmlActionFormContainerId, anActionFormManager)
	{
		...
		// Questo url viene passato al server per permettere la composizione dell'url effettivo per la cancellazione
		// del file vero e proprio.... o lo posso fare diversamente? 
		// Potrei farlo nella callback: fileuploaddestroy
	...
	open : function(anAttachmentGroupId)
	{
		...
		this.attachmentGroupId = anAttachmentGroupId;
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/jsportlet/outmail/UploadFileActionForm.html.jsp'),
			dataType : "html"
		});
		...
		{			
			...
			var aRestUrl = 	org.r3.PageManager.getRESTUrl('POST_Mail_Attachment_File', [ anAttachmentGroupId ]);
			if (r3_IE)
				aRestUrl =	org.r3.PageManager.getRESTUrl('POST_Mail_Attachment_File_IE', [ anAttachmentGroupId ]);						
			...
			.bind('fileuploaddestroy', function (e, data) {
				...
				if (data.type == 'DELETE')
				    data.url = org.r3.PageManager.getRESTUrl('DELETE_Mail_Attachment_File', [ _self.attachmentGroupId,  data.url]); 
            });
