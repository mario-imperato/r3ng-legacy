...
<div class="box box-widget timelinepost post-blue" id="post_{%=o.post.dataBean.postid%}">
	<div class="box-header with-border">
		<div class="user-block">
			...
			{% if (o.post.isGeoLocated()) { %}				
			<span class="infomessage" >{%=o.post.getGeoLocationAsString()%}</span>
			{% } %}											
		</div>
		<!-- /.user-block -->
		<div class="box-tools">
			...
			{% if (o.post.isGeoLocated()) { %}
			<button type="button" class="btn btn-box-tool" data-action='primary-view-position' >
			...
			{% } %}	
			{% if (o.contentClassObj.isActionEnabled('delete', o.post)) { %}
