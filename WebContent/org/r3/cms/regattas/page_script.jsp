...
<r3_lang:environment id="r3Env">
  ...
  <r3_lang:script path2resolve="/org/r3/cms/regattas/PageManager.js" />
  <r3_lang:script path2resolve="/org/r3/cms/regattas/messages.js" />
  ...
  <r3_lang:script path2resolve="/org/r3/jsportlet/cms/CMSPage_CardPagedIndexActionForm.js" />
  <r3_lang:script path2resolve="/org/r3/jsportlet/cms/CMSPage_CardPagedIndexActionFormView.js" />
  <r3_lang:script path2resolve="/org/r3/jsportlet/cms/CMSPage_CardDetailActionForm.js" />
  <r3_lang:script path2resolve="/org/r3/jsportlet/cms/CMSPage_CardDetailActionFormView.js" />  
  ...
  $(document).ready(function()
  {
    ...
    org.r3.PageManager.networkInitialization(
    {
      success : function()
      {
        ...
        org.r3.cms.regattas.PageManager.init({ pageid : '<%=pageDTO.getPageidAsString()%>', pagetype : '<%=pageDTO.getPagetypeAsString()%>' }, { cardid : '<%=cardDTO.getCardidAsString()%>', title : <%=StringUtils.convert2JSONString(cardDTO.getSystemtitleAsString())%>  });
