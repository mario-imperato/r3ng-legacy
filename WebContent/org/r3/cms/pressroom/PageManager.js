$.r3Utils.namespace("org.r3.cms.pressroom");

org.r3.cms.pressroom.PageManager = 
{
	...
	openCMSPage : function(pageInfo, cardInfo)
	{
			...
			this.cmsPageActionForm.open(pageInfo, cardInfo, { 
				"cardindexquery": "groupid=grp_pressinfo", "cardtemplate": "cms_tpl_cardview_type3", "downloadCanvas": false  
			});		
	 }
