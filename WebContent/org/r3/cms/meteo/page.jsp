...
<tiles:insert definition="<%=lyt%>" >
   ...
   <style>
   @import '<r3_lang:pathResolver path="/org/r3/cms/meteo/page_style.css" />'; 
   </style>       
   </tiles:put>
   
   <tiles:putList name="windowLayout_canvasList">
      <tiles:add value="/org/r3/cms/meteo/page_canvas.jsp" />
      
   </tiles:putList>

   <tiles:putList name="windowLayout_scriptList">
      <tiles:add value="/org/r3/cms/meteo/page_script.jsp" />
   </tiles:putList>
