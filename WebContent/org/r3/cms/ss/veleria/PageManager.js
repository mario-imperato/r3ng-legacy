$.r3Utils.namespace("org.r3.cms.ss.veleria");

org.r3.cms.ss.veleria.PageManager = 
{
	...
	openCMSPage : function(pageInfo, cardInfo)
	{
			...
			this.cmsPageActionForm.open(pageInfo, cardInfo, { 
				"cardindexquery": "groupid=veleria", "cardtemplate": "cms_tpl_cardview_type3", "downloadCanvas": false  
			});		
	 }
