...
<r3_lang:environment id="r3Env">
  ...
  <r3_lang:script path2resolve="/org/r3/cms/ss/spi/PageManager.js" />
  <r3_lang:script path2resolve="/org/r3/cms/ss/spi/messages.js" />
  ...
  $(document).ready(function()
  {
    ...
    org.r3.PageManager.networkInitialization(
    {
      success : function()
      {
        ...
        org.r3.cms.ss.spi.PageManager.init({ pageid : '<%=pageDTO.getPageidAsString()%>', pagetype : '<%=pageDTO.getPagetypeAsString()%>' }, { cardid : '<%=cardDTO.getCardidAsString()%>', title : <%=StringUtils.convert2JSONString(cardDTO.getSystemtitleAsString())%>  });
