$.r3Utils.namespace("org.r3.cms.ss.genoa");

org.r3.cms.ss.genoa.PageManager = 
{
	...
	openCMSPage : function(pageInfo, cardInfo)
	{
			...
			this.cmsPageActionForm.open(pageInfo, cardInfo, { 
				"cardindexquery": "groupid=genoa", "cardtemplate": "cms_tpl_cardview_type3", "downloadCanvas": false  
			});		
	 }
