...
<r3_lang:environment id="r3Env">
  ...
  <r3_lang:script path2resolve="/org/r3/cms/grouppage1/PageManager.js" />
  <r3_lang:script path2resolve="/org/r3/cms/grouppage1/messages.js" />
  <r3_lang:script path2resolve="/org/r3/jsportlet/cms/indexdetail/CMSPage_CardIndexDetailActionForm.js" />
  <r3_lang:script path2resolve="/org/r3/jsportlet/cms/indexdetail/CMSPage_CardIndexDetailActionFormView.js" />
  ...
  $(document).ready(function()
  {
    ...
    org.r3.PageManager.networkInitialization(
    {
      success : function()
      {
        ...
        org.r3.cms.grouppage1.PageManager.init(
          { 
        	pageid : '<%=pageDTO.getPageidAsString()%>', 
        	pagetitle: <%=StringUtils.convert2JSONString(pageDTO.getPagetitleAsString())%>, 
        	pagetype : '<%=pageDTO.getPagetypeAsString()%>' 
          }, 
          { 
