...
jQuery.r3Utils.namespace("org.r3.db.cms.group");

org.r3.db.cms.group.GroupQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.cms.group.GroupDTOAdapter(aRowDataBean); });   
      return adapter;
   },
   ...
   { 
        ...
        defaultColumnDefinitions['groupid'] = 
       {
        ...
        defaultColumnDefinitions['groupname'] = 
       {
       	  "aTargets": [ -1 ],
          "sClass": "left",
          "sTitle": "groupname",
          ...
          {
             var item = oObj.aData; 
             return item.dataBean.groupname || '';
          }       
       };
   ...
   {
   	  var adaptedItem = new org.r3.db.cms.group.GroupDTOAdapter(anItem);   
