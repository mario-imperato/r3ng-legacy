...
org.r3.db.cms.cardchannelview.CardChannelViewQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.cms.cardchannelview.CardChannelViewDTOAdapter(aRowDataBean); });
      return adapter;
   },

   _setupDefaultColumnDefinitions: function()
   {
       return org.r3.db.cms.cardchannelview.CardChannelViewQueryActionFormView_ColumnDefinitions (this.dataTableId);
   },

   addRawItem: function(anItem)
   {
   	  var adaptedItem = new org.r3.db.cms.cardchannelview.CardChannelViewDTOAdapter(anItem);
...
org.r3.db.cms.cardchannelview.CardChannelViewQueryActionFormView_ColumnDefinitions  = function(theDataTableId, includeOnlyFieldList)
{
    var defaultColumnDefinitions = {};

    var attributekey = 'channelid_site_cardid';
...
//       	    }
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.channelid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
          		return item.getChannelidDescr() || '';
       		}
    	};
    }
 	var columnId = 'site';
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.site,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
          		return item.getSiteDescr() || '';
       		}
    	};
    }
 	var columnId = 'cardid';
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.cardid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.languagecode,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.categoryid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.pagelinktype,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.pagelink,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.pageid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.refdate,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.options,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.title,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.summary,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.textbody,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.cms.cardchannelview.message.rectimestamp,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
