...
org.r3.db.sailevent.rankinginstanceview.RankingInstanceViewQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.sailevent.rankinginstanceview.RankingInstanceViewDTOAdapter(aRowDataBean); });   
      return adapter;
   },
...
//          	    }
        ...
        defaultColumnDefinitions['ranktitle'] = 
       {
         ...
         defaultColumnDefinitions['raceclass'] = 
        {
         ...
         defaultColumnDefinitions['rankrateorg'] = 
         {
         	  "aTargets": [ -1 ],
            "sClass": "left",
            "sTitle": "rankrateorg",
            ...
            {
               var item = data; 
               return item.dataBean.rankrateorg || '';
            }       
         };
        ...
        defaultColumnDefinitions['racenumber'] = 
       {
          ...
          {
             var item = data; 
             if (item.dataBean.racenumber && item.dataBean.racenumber == 99)
            	 return 'Generale';
   ...
   {
   	  var adaptedItem = new org.r3.db.sailevent.rankinginstanceview.RankingInstanceViewDTOAdapter(anItem);   
