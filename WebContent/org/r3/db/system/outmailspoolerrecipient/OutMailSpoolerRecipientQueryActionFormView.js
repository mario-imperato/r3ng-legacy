...
org.r3.db.system.outmailspoolerrecipient.OutMailSpoolerRecipientQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.system.outmailspoolerrecipient.OutMailSpoolerRecipientDTOAdapter(aRowDataBean); });
      return adapter;
   },

   _setupDefaultColumnDefinitions: function()
   {
       return org.r3.db.system.outmailspoolerrecipient.OutMailSpoolerRecipientQueryActionFormView_ColumnDefinitions (this.dataTableId);
   },

   addRawItem: function(anItem)
   {
   	  var adaptedItem = new org.r3.db.system.outmailspoolerrecipient.OutMailSpoolerRecipientDTOAdapter(anItem);
...
org.r3.db.system.outmailspoolerrecipient.OutMailSpoolerRecipientQueryActionFormView_ColumnDefinitions  = function(theDataTableId, includeOnlyFieldList)
{
...
//       	    }
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.recipientid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
          		return item.dataBean.recipientid || '';
       		}
    	};
    }
 	var columnId = 'site';
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.site,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.messageid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.msgto,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
          		return item.dataBean.msgto || '';
       		}
    	};
    }
 	var columnId = 'businesskey';
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.businesskey,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.recstatus,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.system.outmailspoolerrecipient.message.rectimestamp,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
