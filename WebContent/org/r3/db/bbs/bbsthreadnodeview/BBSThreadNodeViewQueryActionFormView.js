...
org.r3.db.bbs.bbsthreadnodeview.BBSThreadNodeViewQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.bbs.bbsthreadnodeview.BBSThreadNodeViewDTOAdapter(aRowDataBean); });
      return adapter;
   },

   _setupDefaultColumnDefinitions: function()
   {
       return org.r3.db.bbs.bbsthreadnodeview.BBSThreadNodeViewQueryActionFormView_ColumnDefinitions (this.dataTableId);
   },

   addRawItem: function(anItem)
   {
   	  var adaptedItem = new org.r3.db.bbs.bbsthreadnodeview.BBSThreadNodeViewDTOAdapter(anItem);
...
org.r3.db.bbs.bbsthreadnodeview.BBSThreadNodeViewQueryActionFormView_ColumnDefinitions  = function(theDataTableId, includeOnlyFieldList)
{
...
//       	    }
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.threadnodeid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.site,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.threadid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.nodetype,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.nodetitle,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.nodetext,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.nodeparentid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.nodepath,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.userid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.nickname,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.firstname,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.lastname,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.creationdate,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.recstatus,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.bbs.bbsthreadnodeview.message.rectimestamp,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
