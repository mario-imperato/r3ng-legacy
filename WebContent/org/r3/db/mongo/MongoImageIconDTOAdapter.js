...
org.r3.db.mongo.MongoImageIconDTO = Class.extend(
 {
     init: function(aDataBean)
	 {
        this.imageiconid = aDataBean.imageiconid || null;    	 
        this.imagerole = aDataBean.imagerole || null;
        this.image = aDataBean.image || null;
        this.icon = aDataBean.icon || null;        
	 }	   
 });  

org.r3.db.mongo.MongoImageIconDTOAdapter = org.r3.db.DTOAdapter.extend(
{
	init : function(aDataBean)
	{
		this._super(new org.r3.db.mongo.MongoImageIconDTO(aDataBean));
	},
	
	isOfRole: function(aRole)
	{
		var b = 
		this.dataBean.imagerole  && aRole  && this.dataBean.imagerole == aRole;
	...
	hasImage: function()
	{
		return this.dataBean.image;
	},
	
	getImage: function()
	{
		if (this.dataBean.image)
			return new org.r3.db.mongo.MongoImageDTOAdapter(this.dataBean.image);
	...
	hasIcon: function()
	{
		return this.dataBean.icon;
	},

	getIcon: function()
	{
		if (this.dataBean.icon)
			return new org.r3.db.mongo.MongoImageDTOAdapter(this.dataBean.icon);
...
org.r3.db.mongo.MongoImageIconQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.mongo.MongoImageIconDTOAdapter(aRowDataBean); });
      return adapter;
   },

   _setupDefaultColumnDefinitions: function()
   {
       return org.r3.db.mongo.MongoImageIconQueryActionFormView_ColumnDefinitions (this.dataTableId);
   },

   addRawItem: function(anItem)
   {
   	  var adaptedItem = new org.r3.db.mongo.MongoImageIconDTOAdapter(anItem);
...
org.r3.db.mongo.MongoImageIconQueryActionFormView_ColumnDefinitions  = function(theDataTableId, includeOnlyFieldList)
{
