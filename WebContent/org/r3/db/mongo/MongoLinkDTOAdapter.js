...
org.r3.db.mongo.MongoLinkDTO = Class.extend(
 {
     init: function(aDataBean)
	 {
        this.linkid = aDataBean.linkid || null; 
        this.refattachmentid = aDataBean.refattachmentid || null;
        this.href = aDataBean.href || null;
        this.name = aDataBean.name || null;
        this.linktype = aDataBean.linktype || null;                
	 }	   
 });  

org.r3.db.mongo.MongoLinkDTOAdapter = org.r3.db.DTOAdapter.extend(
{
	init : function(aDataBean)
	{
		this._super(new org.r3.db.mongo.MongoLinkDTO(aDataBean));
	}

});

org.r3.db.mongo.MongoLinkQueryActionFormView = org.r3.db.DataTableEntityActionFormView.extend(
{
   //
   ...
   {
      var adapter = new org.r3.db.DTOTableAdapter(serverResponseData, function(aRowDataBean) { return new org.r3.db.mongo.MongoLinkDTOAdapter(aRowDataBean); });
      return adapter;
   },

   _setupDefaultColumnDefinitions: function()
   {
       return org.r3.db.mongo.MongoLinkQueryActionFormView_ColumnDefinitions (this.dataTableId);
   },

   addRawItem: function(anItem)
   {
   	  var adaptedItem = new org.r3.db.mongo.MongoLinkDTOAdapter(anItem);
...
org.r3.db.mongo.MongoLinkQueryActionFormView_ColumnDefinitions  = function(theDataTableId, includeOnlyFieldList)
{
...
//				       	    }
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.mongo.postcollection.message.link_linkid,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
          		return item.dataBean.linkid || '';
       		}
    	};
    }
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.mongo.postcollection.message.link_href,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
          		return item.dataBean.href || '';
       		}
    	};
    }
	...
	if (!includeOnlyFieldList || includeOnlyFieldList.indexOf(columnId) >= 0)
	{
    	defaultColumnDefinitions[columnId] =
    	{
    	  	"aTargets": [ -1 ],
       		"sClass": "text-left",
       		"sTitle": org.r3.db.mongo.postcollection.message.link_name,
       		"render": function ( data, type, row, meta )
       		{
          		var item = data;
