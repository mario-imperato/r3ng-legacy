...
//          }));
   ...
   getAoColumnDefs: function()
   {
       ...
       for(var i = 0; i < columnIds.length; i++)
       {
           ...
           if (colDef)
           {
               ...
               // All'interno dei generatori la proprietà sName è stata inserita successivamente.
   ...
   getFilterSearchItem: function()
   {
	   ...
	   // Organizzo così il controllo. In caso di errore il chiamante non si rompe in quanto torno comunque un oggetto jQuery
