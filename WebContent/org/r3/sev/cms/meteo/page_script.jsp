...
<r3_lang:environment id="r3Env">
  ...
  <r3_lang:script path2resolve="/org/r3/sev/cms/meteo/PageManager.js" />
  <r3_lang:script path2resolve="/org/r3/sev/cms/meteo/messages.js" />
  <r3_lang:comment>  
  ...
  $(document).ready(function()
  {
    ...
    org.r3.PageManager.networkInitialization(
    {
      success : function()
      {
        ...
        org.r3.sev.cms.meteo.PageManager.init({ pageid : '<%=pageDTO.getPageidAsString()%>', pagetype : '<%=pageDTO.getPagetypeAsString()%>' }, { cardid : '<%=cardDTO.getCardidAsString()%>', title : <%=StringUtils.convert2JSONString(cardDTO.getSystemtitleAsString())%>  });
