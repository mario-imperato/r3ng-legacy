...
org.r3.home.mastersite.HomePageActionFormView = org.r3.ActionFormView.extend(
{
	...
	open : function(siteTypeFilter)
	{
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/home/mastersite/HomePageActionForm.html.jsp'),
			dataType : "html"
		});
		...
		networkRequestsQueue.push(
		{
			id : "events",
			type : "Get",
			url : org.r3.PageManager.getRESTUrl('LUT_Site_Children'), // 'LUT_Site_OfType', [ siteTypeFilter ]),
			dataType : "json"
		});		
		}
		else
