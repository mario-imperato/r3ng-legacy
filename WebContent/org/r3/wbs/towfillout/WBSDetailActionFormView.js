...
org.r3.wbs.towfillout.WBSDetailActionFormView = org.r3.ActionFormView.extend(
{
...
//		});				
		...
		networkRequestsQueue.push(
		{
			id : "view",
			type : "Get",
			url : org.r3.PageManager.getVersionedUIURL(org.r3.Constants.applicationContext + '/org/r3/wbs/towfillout/WBSDetailActionFormView.html.jsp'),
			dataType : "html"
		});
...
//			}
    		...
    		teamDashBoard.open(wbsDTOAdapter.dataBean.wbsid, org.r3.Constants.site);
