...
org.r3.wbs.towfillout.NavigatorActionForm = org.r3.ActionFormManager.extend(
{

	init : function(aPageManager, aDetailViewContainerId, aChildEntityListViewContainerId)
	{
		this.setPageManager(aPageManager);
		this.detailView = new org.r3.wbs.towfillout.NavigatorActionFormView(aDetailViewContainerId, this);
	},
