...
<r3_lang:environment id="r3Env" namespace='org.r3.console.users'>
...
<tiles:insert definition="<%=lyt%>" >
   ...
   <tiles:put  name="windowLayout_pageTitle" >Console - Gestione Utenti</tiles:put>
   <tiles:put  name="windowLayout_cssprofile" >default-layout-cssprofile</tiles:put>   
   <tiles:putList name="windowLayout_canvasList">
      <tiles:add value="/org/r3/console/users/page_canvas.jsp" />
   </tiles:putList>

   <tiles:putList name="windowLayout_scriptList">
      <tiles:add value="/org/r3/console/users/page_script.jsp" />
   </tiles:putList>   
