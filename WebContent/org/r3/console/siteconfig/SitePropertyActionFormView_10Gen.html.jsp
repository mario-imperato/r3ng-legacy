...
<!-- Nav tabs -->
 <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#sitePropertiesActionForm_tab_address" role="tab" data-toggle="tab">{%=org.r3.console.siteconfig.message.sitePropertiesActionForm_tab_address%}</a></li>
  ...
  <div id="sitePropertiesActionForm_tab_address" class='tab-pane tab-pane-framed' ></div>
  </div>
