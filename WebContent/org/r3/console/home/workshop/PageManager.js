$.r3Utils.namespace("org.r3.console.home.workshop");

org.r3.console.home.workshop.PageManager = 
{
...
//		 
//		 $('#consolehome_action_contacts').unbind().click(function(e) {
...
{ 
	 ...
	 {		
		 ...
		 if (lutPageItem)
		 {
			 var sideBarItem = {			    
					id : 'act_sevapp',
					title : org.r3.message.gmenubar_act_sevapp,
					onClick : onClickCallBack,
					deletable: false,
					selected: false,
					icon: 'users'
		 ...
		 if (lutPageItem)
		 {
			 var sideBarItem = {			    
					id : 'act_sevrank',
					title : org.r3.message.gmenubar_act_sevrank,
					onClick : onClickCallBack,
					deletable: false,
					selected: false,
					icon: 'users'
...
openNewSitePanel : function()
{
	...
	{
		"title" : org.r3.console.home.mastersite.message.breadcrumb_newsite,
...
{		 
	 org.r3.PageManager.pushBreadCrumb(
	{
		"title" : org.r3.console.home.mastersite.message.breadcrumb_querysites,
...
openRegattaDetailPanel : function(regattaDataBean)
{
	org.r3.PageManager.pushBreadCrumb(
	{
		"title" : org.r3.console.home.mastersite.message.breadcrumb_sitedeatil,
		"actionForm" : this.regattaDetailActionForm
	});
