$.r3Utils.namespace("org.r3.console.home.yachtclubsite");

org.r3.console.home.yachtclubsite.PageManager = 
{
...
//		 },
		 ...
		 { 
			 ...
			 {		
				 ...
				 var sideBarItem = {			    
					id : 'act_tutorials',
					title : org.r3.message.gmenubar_act_tutorials,
					onClick : onClickCallBack,
					deletable: false,
					selected: false,
					icon: 'cog'
		 ...
		 openNewSitePanel : function()
		 {
			...
			{
				"title" : org.r3.message.breadcrumb_newsite,
		...
		closeNewSitePanel: function()
		{
	     ...
	     {		 
			 org.r3.PageManager.pushBreadCrumb(
			{
				"title" : org.r3.message.breadcrumb_querysites,
		 ...
		 openRegattaDetailPanel : function(regattaDataBean)
		 {
			org.r3.PageManager.pushBreadCrumb(
			{
				"title" : org.r3.message.breadcrumb_sitedeatil,
				"actionForm" : this.regattaDetailActionForm
			});
