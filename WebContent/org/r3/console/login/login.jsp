...
<r3_lang:environment id="r3Env" namespace='org.r3.console.login'>
...
<tiles:insert definition="<%=lyt%>" >
   ...
   <tiles:put  name="windowLayout_pageTitle" >Console - Login Page</tiles:put>
   <tiles:putList name="windowLayout_canvasList">
      <tiles:add value="/org/r3/console/login/page_canvas.jsp" />
   </tiles:putList>

   <tiles:putList name="windowLayout_scriptList">
      <tiles:add value="/org/r3/console/login/page_script.jsp" />
   </tiles:putList>
