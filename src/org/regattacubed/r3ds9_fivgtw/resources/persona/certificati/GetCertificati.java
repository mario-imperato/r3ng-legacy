...
public class GetCertificati extends ResourceOperationQuery {

    public GetCertificati(HttpClient aClient, HttpHost aTargetHost) {
        super(aClient, aTargetHost);
    }

    public List<InfoCertificatoMedico> query() throws ResourceOperationException {
        ...
        try {
            ...
            TypeReference ref = new TypeReference<FivSiteApiResponseList<InfoCertificatoMedico>>() {
            };
            FivSiteApiResponseList<InfoCertificatoMedico> apiResponse = (FivSiteApiResponseList<InfoCertificatoMedico>) objectMapper.readValue(jsonData, ref);
