...
@javax.xml.bind.annotation.XmlRootElement(name = "CardChannelViewDTOBase")
public class CardChannelViewDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    public static final int CATEGORYID_DIRTYMASK   =  16;
    public static final int PAGELINKTYPE_DIRTYGROUP  =  0;
    public static final int PAGELINKTYPE_DIRTYMASK   =  32;
    ...
    public static final int PAGEID_DIRTYMASK   =  128;
    public static final int REFDATE_DIRTYGROUP  =  0;
    public static final int REFDATE_DIRTYMASK   =  256;
    public static final int OPTIONS_DIRTYGROUP  =  0;
    public static final int OPTIONS_DIRTYMASK   =  512;
    public static final int TITLE_DIRTYGROUP  =  0;
    public static final int TITLE_DIRTYMASK   =  1024;
    public static final int SUMMARY_DIRTYGROUP  =  0;
    public static final int SUMMARY_DIRTYMASK   =  2048;
    public static final int TEXTBODY_DIRTYGROUP  =  0;
    public static final int TEXTBODY_DIRTYMASK   =  4096;
    ...
    /**
      * Copy constructor.
      */
    public CardChannelViewDTOBase(CardChannelViewDTOBase another)
    {
