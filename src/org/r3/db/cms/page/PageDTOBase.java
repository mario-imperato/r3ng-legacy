...
@javax.xml.bind.annotation.XmlRootElement(name = "PageDTOBase")
public class PageDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    public static final int PAGETYPE_DIRTYMASK   =  4;
    ...
    public static final int PAGEICON1_DIRTYMASK   =  16;
    public static final int PAGEICON2_DIRTYGROUP  =  0;
    public static final int PAGEICON2_DIRTYMASK   =  32;
    public static final int PAGELINK_DIRTYGROUP  =  0;
    public static final int PAGELINK_DIRTYMASK   =  64;
    public static final int PAGEORDER_DIRTYGROUP  =  0;
    public static final int PAGEORDER_DIRTYMASK   =  128;
    public static final int VISIBILITY_DIRTYGROUP  =  0;
    public static final int VISIBILITY_DIRTYMASK   =  256;
    public static final int PAGESTYLE_DIRTYGROUP  =  0;
    public static final int PAGESTYLE_DIRTYMASK   =  512;
    public static final int FORWARDVIEW_DIRTYGROUP  =  0;
    public static final int FORWARDVIEW_DIRTYMASK   =  1024;
    public static final int ONUSERSTATUS_DIRTYGROUP  =  0;
    public static final int ONUSERSTATUS_DIRTYMASK   =  2048;
    public static final int PERMISSIONS_DIRTYGROUP  =  0;
    public static final int PERMISSIONS_DIRTYMASK   =  4096;
    public static final int VIEWOPTIONS_DIRTYGROUP  =  0;
    public static final int VIEWOPTIONS_DIRTYMASK   =  8192;
    ...
    /**
      * Copy constructor.
      */
    public PageDTOBase(PageDTOBase another)
    {
