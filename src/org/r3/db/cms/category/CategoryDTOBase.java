...
@javax.xml.bind.annotation.XmlRootElement(name = "CategoryDTOBase")
public class CategoryDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    public static final int CATEGORYDESCR_DIRTYMASK   =  8;
    public static final int PREVIEWTMPL_DIRTYGROUP  =  0;
    public static final int PREVIEWTMPL_DIRTYMASK   =  16;
    public static final int FULLTMPL_DIRTYGROUP  =  0;
    public static final int FULLTMPL_DIRTYMASK   =  32;


    /**
      * DataBean constructor.
      */
    public CategoryDTOBase()
    {
    ...
    /**
      * Copy constructor.
      */
    public CategoryDTOBase(CategoryDTOBase another)
    {
