...
@javax.xml.bind.annotation.XmlRootElement(name = "CardPropertyDTOBase")
public class CardPropertyDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    public static final int PROPERTYID_DIRTYMASK   =  1;
    ...
    public static final int PROPERTYROLE_DIRTYMASK   =  16;
    public static final int PROPERTYTYPECODE_DIRTYGROUP  =  0;
    public static final int PROPERTYTYPECODE_DIRTYMASK   =  32;
    public static final int PROPERTYNAME_DIRTYGROUP  =  0;
    public static final int PROPERTYNAME_DIRTYMASK   =  64;
    public static final int PROPERTYVALUE_DIRTYGROUP  =  0;
    public static final int PROPERTYVALUE_DIRTYMASK   =  128;
    public static final int PROPERTYSIZE_DIRTYGROUP  =  0;
    public static final int PROPERTYSIZE_DIRTYMASK   =  256;
    public static final int REFPROPERTYID_DIRTYGROUP  =  0;
    public static final int REFPROPERTYID_DIRTYMASK   =  512;
    public static final int CONTENTTYPE_DIRTYGROUP  =  0;
    public static final int CONTENTTYPE_DIRTYMASK   =  1024;
    public static final int IMAGEURL_DIRTYGROUP  =  0;
    public static final int IMAGEURL_DIRTYMASK   =  2048;
    public static final int IMAGEHEIGHT_DIRTYGROUP  =  0;
    public static final int IMAGEHEIGHT_DIRTYMASK   =  4096;
    public static final int IMAGEWIDTH_DIRTYGROUP  =  0;
    public static final int IMAGEWIDTH_DIRTYMASK   =  8192;
    public static final int ICONURL_DIRTYGROUP  =  0;
    public static final int ICONURL_DIRTYMASK   =  16384;
    public static final int ICONWIDTH_DIRTYGROUP  =  0;
    public static final int ICONWIDTH_DIRTYMASK   =  32768;
    public static final int ICONHEIGHT_DIRTYGROUP  =  0;
    public static final int ICONHEIGHT_DIRTYMASK   =  65536;
    public static final int RECSTATUS_DIRTYGROUP  =  0;
    public static final int RECSTATUS_DIRTYMASK   =  131072;
    public static final int RECTIMESTAMP_DIRTYGROUP  =  0;
    public static final int RECTIMESTAMP_DIRTYMASK   =  262144;


    /**
      * DataBean constructor.
      */
    public CardPropertyDTOBase()
    {
       dirtyFlagsArray = new int[19 / 30 + 1];
       clearDirtyFlags();
    ...
    /**
      * Copy constructor.
      */
    public CardPropertyDTOBase(CardPropertyDTOBase another)
    {
