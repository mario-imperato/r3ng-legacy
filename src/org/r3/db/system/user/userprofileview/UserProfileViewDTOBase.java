...
@javax.xml.bind.annotation.XmlRootElement(name = "UserProfileViewDTOBase")
public class UserProfileViewDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    protected java.lang.String  functioncode;
    ...
    public static final java.lang.String FUNCTIONCODE_DEFAULT  =  null;
    ...
    public static final int USERTYPE_DIRTYMASK   =  64;
    public static final int AVATARROLE_DIRTYGROUP  =  0;
    public static final int AVATARROLE_DIRTYMASK   =  128;
    public static final int PARENTUSERID_DIRTYGROUP  =  0;
    public static final int PARENTUSERID_DIRTYMASK   =  256;
    public static final int USERPHOTO_DIRTYGROUP  =  0;
    public static final int USERPHOTO_DIRTYMASK   =  512;
    public static final int LASTLOGIN_DIRTYGROUP  =  0;
    public static final int LASTLOGIN_DIRTYMASK   =  1024;
    public static final int NUMBEROFLOGINS_DIRTYGROUP  =  0;
    public static final int NUMBEROFLOGINS_DIRTYMASK   =  2048;
    public static final int USERCONSENT_DIRTYGROUP  =  0;
    public static final int USERCONSENT_DIRTYMASK   =  4096;
    public static final int FBUSERID_DIRTYGROUP  =  0;
    public static final int FBUSERID_DIRTYMASK   =  8192;
    public static final int RECSTATUS_DIRTYGROUP  =  0;
    public static final int RECSTATUS_DIRTYMASK   =  16384;
    public static final int SITE_DIRTYGROUP  =  0;
    public static final int SITE_DIRTYMASK   =  32768;
    public static final int ROLEID_DIRTYGROUP  =  0;
    public static final int ROLEID_DIRTYMASK   =  65536;
    public static final int FUNCTIONCODE_DIRTYGROUP  =  0;
    public static final int FUNCTIONCODE_DIRTYMASK   =  131072;


    /**
      * DataBean constructor.
      */
    public UserProfileViewDTOBase()
    {
       ...
       functioncode = FUNCTIONCODE_DEFAULT;
    }

    /**
      * Copy constructor.
      */
    public UserProfileViewDTOBase(UserProfileViewDTOBase another)
    {
       ...
       functioncode = another.getFunctioncode();
    ...
    @com.fasterxml.jackson.annotation.JsonIgnore
    @javax.xml.bind.annotation.XmlTransient 
    @CSVAnnotation(attribute = "roleid")
    ...
    {
       setRoleid(p, DTOCasingStyle.none);
    }
    
    public void setRoleid(String  p, DTOCasingStyle casingStyle)
    {
    	 if (p != null)
    	 {
    	  p = p.trim();
    ...
    // functioncode getter methods.
    
    @com.fasterxml.jackson.annotation.JsonIgnore
    @javax.xml.bind.annotation.XmlTransient 
    public boolean isFunctioncodeDirty()  { return checkFieldDirtiness(FUNCTIONCODE_DIRTYGROUP, FUNCTIONCODE_DIRTYMASK); }

    public java.lang.String   getFunctioncode()         { return functioncode; }
    @com.fasterxml.jackson.annotation.JsonIgnore
    @javax.xml.bind.annotation.XmlTransient 
    @CSVAnnotation(attribute = "functioncode")
    public java.lang.String   getFunctioncodeAsString() { return (functioncode == null) ? "" : functioncode; }

    // functioncode setter methods.
    
    protected void markFunctioncodeAsDirty(boolean aFlag)  { markFieldAsDirty(FUNCTIONCODE_DIRTYGROUP, FUNCTIONCODE_DIRTYMASK, aFlag); }


    public void setFunctioncode(String  p)
    {
       setFunctioncode(p, DTOCasingStyle.none);
    }
    
    public void setFunctioncode(String  p, DTOCasingStyle casingStyle)
    {
    	 if (p != null)
    	 {
    	  p = p.trim();
       ...
       markFunctioncodeAsDirty(!equalsObject(functioncode, p));
       functioncode = p;
    }
