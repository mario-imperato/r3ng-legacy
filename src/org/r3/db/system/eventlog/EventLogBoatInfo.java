...
public class EventLogBoatInfo extends EventLogDTO
{
    public EventLogBoatInfo(String site, String applicationId, String aUserId)
    {
    	this.setUsecaseambit(UseCaseAmbit.sev_application);
    	this.setUsecase(UseCase.ev_boatinfo);
    	this.setSite(site);
