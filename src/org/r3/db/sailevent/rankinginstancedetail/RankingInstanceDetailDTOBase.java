...
@javax.xml.bind.annotation.XmlRootElement(name = "RankingInstanceDetailDTOBase")
public class RankingInstanceDetailDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    /**
      ...
      */
    public RankingInstanceDetailDTOBase()
    {
       dirtyFlagsArray = new int[52 / 30 + 1];
       clearDirtyFlags();
    ...
    /**
      * Copy constructor.
      */
    public RankingInstanceDetailDTOBase(RankingInstanceDetailDTOBase another)
    {
