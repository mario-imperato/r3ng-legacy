...
@javax.xml.bind.annotation.XmlRootElement(name = "BBSTopicDTOBase")
public class BBSTopicDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    /**
      * Copy constructor.
      */
    public BBSTopicDTOBase(BBSTopicDTOBase another)
    {
