...
@javax.xml.bind.annotation.XmlRootElement(name = "BBSThreadNodeViewDTOBase")
public class BBSThreadNodeViewDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    public static final int NICKNAME_DIRTYMASK   =  512;
    public static final int FIRSTNAME_DIRTYGROUP  =  0;
    public static final int FIRSTNAME_DIRTYMASK   =  1024;
    public static final int LASTNAME_DIRTYGROUP  =  0;
    public static final int LASTNAME_DIRTYMASK   =  2048;
    public static final int CREATIONDATE_DIRTYGROUP  =  0;
    public static final int CREATIONDATE_DIRTYMASK   =  4096;
    ...
    /**
      ...
      */
    public BBSThreadNodeViewDTOBase()
    {
    ...
    /**
      * Copy constructor.
      */
    public BBSThreadNodeViewDTOBase(BBSThreadNodeViewDTOBase another)
    {
