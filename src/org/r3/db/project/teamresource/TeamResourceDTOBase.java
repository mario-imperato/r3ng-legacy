...
@javax.xml.bind.annotation.XmlRootElement(name = "TeamResourceDTOBase")
public class TeamResourceDTOBase extends org.r3.db.DTOBase
{
    int[] dirtyFlagsArray;
    ...
    public static final int RESOURCEID_DIRTYMASK   =  4;
    public static final int PROFILEID_DIRTYGROUP  =  0;
    public static final int PROFILEID_DIRTYMASK   =  8;
    public static final int EVALUEUNIT_DIRTYGROUP  =  0;
    public static final int EVALUEUNIT_DIRTYMASK   =  16;
    public static final int PRICE_DIRTYGROUP  =  0;
    public static final int PRICE_DIRTYMASK   =  32;
    public static final int COST_DIRTYGROUP  =  0;
    public static final int COST_DIRTYMASK   =  64;
    public static final int RESOURCEDEFSTATUS_DIRTYGROUP  =  0;
    public static final int RESOURCEDEFSTATUS_DIRTYMASK   =  128;
    public static final int RECSTATUS_DIRTYGROUP  =  0;
    public static final int RECSTATUS_DIRTYMASK   =  256;
    ...
    /**
      * Copy constructor.
      */
    public TeamResourceDTOBase(TeamResourceDTOBase another)
    {
