...
public class NewNeighborhood_Notification extends NewSiteRequestNotification
{	
	public NewNeighborhood_Notification(VelocityTemplateModel aVelocityEngine, Properties aContextProperties, SiteDTO aSiteDTO, UserDTO aUser, boolean oneTimePassword)
	{
	...
	{
		notify(ctx, aSession, "NewNeighborhoodRequest_NotificationMailMessage", SitePropertyDTO.SMTP_SYSSUBJECT);
	}
