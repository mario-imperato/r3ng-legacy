...
@Path("{site}/{language}/lut/pages")
public class WsLUTCMSPage  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTCMSPage.class);
	...
	public Response getCentroEsiti(
		     ...
		     @MatrixParam("pagetype") String pageType,
		     @MatrixParam("pagevisibility") String pageVisibility
			)
	{
		...
		GETCMSPageLUTItems bl = new GETCMSPageLUTItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage), pageType, pageVisibility);
