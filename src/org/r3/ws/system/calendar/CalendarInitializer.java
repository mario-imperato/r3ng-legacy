...
import org.r3.db.system.calendar.SystemCalendarDTO.CalendarEntryType;
import org.r3.db.system.calendar.SystemCalendarFilter;
...
private SimpleDateFormat sf;
	...
	public CalendarInitializer(String aSiteDomain, String aCalendarId, String eveStart, int eveStartDayNumber, int calendarLength, boolean computeCalendarPeriodFlag)
	{				
        sf = new SimpleDateFormat("dd/MM/yyyy");
    	
        siteDomain = aSiteDomain;
	...
	protected void process(PersistenceContext pcfg, SqlSession aSession)  throws Exception
	{
		try
		{
			...
			calendarFilter.or().andCalendaridEqualTo(siteDomain).andCalendaridEqualTo(calendarId);
	        ...
	        for(int i = 1; i <= eveLength; i++)
	        {
	        	...
	        	calendarDto.setSitedomain(siteDomain);
