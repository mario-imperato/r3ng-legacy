...
public class GETFileSystemResourceFile extends ServicePattern
{
	...
	public GETFileSystemResourceFile(ServletContext ctx,  ServiceEnvironment serviceEnvironment, String aFileDmsUrl, boolean aForceDownloadFlag)
	{
	...
	{        
		...
		File actualFile = new File("C:/tmp/UNEP_log/UNEP2012/2012/NOV/ALT_2/CLAV_45/GRP_MG/UNEP256/DISTINTA_ACCETTAZIONE_FINAL.PDF");		
		return actualFile;
	}
