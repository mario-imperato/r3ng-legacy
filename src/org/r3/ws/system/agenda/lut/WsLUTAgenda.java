...
@Path("{site}/{language}/lut/agenda")
public class WsLUTAgenda  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTAgenda.class);
			...
			)
	{
		...
		GETAgendaEntryLUTItems bl = new GETAgendaEntryLUTItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage), agendaId);
