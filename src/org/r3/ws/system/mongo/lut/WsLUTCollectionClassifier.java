...
@Path("{site}/{language}/lut/mclassifiers")
public class WsLUTCollectionClassifier  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTCollectionClassifier.class);
		     ...
		     @PathParam("clsid") String aClassifierId)
	{
		...
		ConditionallyGETLUTCollectionItems bl = new ConditionallyGETLUTCollectionItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage), aClassifierId);
