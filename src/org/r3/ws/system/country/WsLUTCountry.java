...
@Path("{site}/{language}/lut/countries")
public class WsLUTCountry  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTCountry.class);
		     ...
		     @PathParam("language") String aLanguage)
	{
		...
		GETCountryLUTItems bl = new GETCountryLUTItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage));
