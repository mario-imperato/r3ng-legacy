...
@Path("{site}/{language}/lut/authroles")
public class WsLUTAuthRole  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTAuthRole.class);
		     ...
		     @PathParam("language") String aLanguage)
	{
		...
		GETAuthRoleLUTItems bl = new GETAuthRoleLUTItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage));
