...
@Path("{site}/{language}/sailevents")
public class WsSailEvent extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsSailEvent.class);
		     ...
		     )
	{
		...
		GETSailEventDetail bl = new GETSailEventDetail(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage), anEventId);
