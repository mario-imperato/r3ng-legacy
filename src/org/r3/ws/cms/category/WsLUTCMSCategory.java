...
@Path("{site}/{language}/cms/lut/category")
public class WsLUTCMSCategory  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTCMSCategory.class);
			...
			)
	{
		...
		GETCMSCategoryLUTItems bl = new GETCMSCategoryLUTItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage));
