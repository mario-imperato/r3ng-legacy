...
@Path("{site}/{language}/resttest")
public class WsTest extends RestService
{
		     ...
		     )
	{
		...
		GETTest bl = new GETTest(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage));
