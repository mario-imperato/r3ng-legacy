...
public class PUTResourceTimesheet extends ServicePattern
{	
    private ResourceTimesheetActionForm actionForm;
    private String resourceId;
    private String timesheetDay;
    
	public PUTResourceTimesheet(ServletContext ctx, ServiceEnvironment serviceEnvironment, String aResourceId, String aTimesheetDay, ResourceTimesheetActionForm anActionForm)
	{
	...
	protected Object process(PersistenceContext pcfg, SqlSession aSession)
	{
		...
		ResourceTimesheetDTO dtoResource = actionForm.getDTO4Insert(senv.getRequestSiteId(), resourceId, dto.getCaleveday(), senv.getUserProfile().getUserid());		
		p.insert(dtoResource, pcfg.getPersistenceConfigInfo());
