...
import org.r3.db.mongo.MongoFileAttachmentDTO.MongoFileAttachmentDataTableAdapter;
...
public class PostFileAttachments_GET extends PostServicePattern
{
	private DataTableQueryActionForm queryActionForm = null;
    
	public PostFileAttachments_GET(ServletContext ctx,  ServiceEnvironment serviceEnvironment, String aSite, String aCardId, DataTableQueryActionForm aQueryActionForm)
	{
	...
	protected Object process(PersistenceContext pcfg, SqlSession aSession)
	{
		...
		{
			MongoFileAttachmentDataTableAdapter dt = new MongoFileAttachmentDataTableAdapter(dto.getAttachments(), queryActionForm.getsEcho());
			return dt;
		}
