...
@Path("{site}/{language}/cms/lut/timelines")
public class WsLUTCMSTimelineCollection  extends RestService
{
	private static Logger logger = LoggerFactory.getLogger(WsLUTCMSTimelineCollection.class);
			...
			)
	{
		...
		GETTimelineCollectionLUTItems bl = new GETTimelineCollectionLUTItems(ctx, getServiceEnvironment(ctx, servletRequest, headers, aSite, aLanguage));
